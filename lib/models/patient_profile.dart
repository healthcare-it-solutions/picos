...
class PatientProfile extends AbstractDatabaseObject {
  ...
  const PatientProfile({
    this.weightBMIEnabled = false,
    this.heartFrequencyEnabled = false,
    this.bloodPressureEnabled = false,
    this.bloodSugarLevelsEnabled = false,
    this.walkDistanceEnabled = false,
    this.sleepDurationEnabled = false,
    this.sleepQualityEnabled = false,
    this.painEnabled = false,
    this.phq4Enabled = false,
    this.medicationEnabled = false,
    this.therapyEnabled = false,
    this.doctorsVisitEnabled = false,

...
/// Class for Mono-button within ListCard.
class PicosListCardMonoButton extends StatelessWidget {
  /// COnstructor for Mono-button.
  const PicosListCardMonoButton({required this.edit, Key? key})
      : super(key: key);
